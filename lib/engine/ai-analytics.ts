...
function buildSystemPrompt(): string {
  return [
    ...
    "  • 综合段位 (overall.label) 由 engine 用'最强项法'评定 — 即用户最强维度的 level, 代表其当前水位",
    "  • 优先突出 level_evaluation.overall.topDimensions (代表水位的强项维度)",
    "  • level_evaluation.overall.improvable 是仍低于综合段位的维度, 可作为'还能提升的方向'适度提及, 但不要把它当成'短板'去 frame, 因为业余车手往往专精某项 (爬坡王/冲刺王/耐力王), 不可能全面 max",
